            ...
            <div className="hidden md:flex md:w-1/2 bg-[#2563EB] text-white p-12 flex-col justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="space-y-6 pt-8">
                        ...
                        <div className="flex items-start gap-4">
                            <div className="p-3 bg-white/10 rounded-xl text-2xl"><HiPresentationChartLine /></div>
                            <div>
                                <p className="font-bold text-lg">Budget Planning</p>
                                <p className="text-sm text-blue-100 opacity-80">Set limits and reach your goals faster.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            <div className="form-control w-full">
                                ...
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-xl text-gray-400 z-10">
                                        <HiMail />
                                    </div>
                            ...
                            <div className="form-control w-full">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="••••••••"
                                        className={`input input-bordered w-full pl-10 pr-10 focus:outline-none focus:border-[#2563EB] ${errors.password ? 'border-error' : ''}`}
                                        {...register("password", { required: "Password is required" })}
                                    />
                                    <button
                                        type="button"
                                        onClick={() => setShowPassword(!showPassword)}
                                        className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 text-xl"
                                    >
