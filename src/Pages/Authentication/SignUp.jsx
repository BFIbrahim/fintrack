            ...
            <div className="hidden md:flex md:w-1/2 bg-[#2563EB] text-white p-12 flex-col justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-8">
                    <h2 className="text-5xl font-extrabold leading-tight">
                        ...
                        <span className="text-[#10B981]">With FinTrack.</span>
                    </h2>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <div className="form-control">
                                ...
                                <div className="relative">
                                    ...
                                    <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-3.5 text-gray-400 text-xl">
